...
%
% 26 July 2019 Modified by S. Datta-Barua, Illinois Institute of Technology
% to update the use of the Matlab built-in intersect and unique functions, preserving the
% legacy form used in versions up to at least R2012b but not R2015a and
% later.  Using the legacy form is enforced with the argument ‘legacy’ in each of those function calls.
...
% S Datta-Barua 26 July 2019 workaround for weird sub2ind operation.
I_d2 = [1:numel(d2_x)]';
...
% 27 July 2019 S. Datta-Barua inserting 'legacy' to force same behavior as
% in MATLAB R2012a.
